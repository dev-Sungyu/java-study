...
//   indexOf() 만들기
//   문자열과 문자를 입력받은 뒤 해당 문자가 몇번째 인덱스에 있는지 검사하고
//   만약 해당 문자가 없으면 -1을 리턴한다.
   		int index(String msg, char examin){
   			for (int i = 0; i < msg.length(); i++) {
   				if(msg.charAt(i) == examin) {
   					return i; 
   				}
			}
   			return -1;
   ...
   public static void main(String[] args) {
      ...
      String result = null;
      result = methodTask.changeToUpperOrLower("aNJDOjs");
...
//      System.out.println("최소값: " + result[1]);
      	...
      	System.out.println(methodTask.index("abcabcabc", 'b'));
   }
}
